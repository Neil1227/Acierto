...
const projects = [
  {
    ...
    title: "RIET Website",
    description:
      "A public-facing website for the  Research, Innovation and Extension Training, built with Laravel and MySQL to provide information access and organizational resources.",
